		            ...
		            <view class="item" v-for="(item,index) in dataList">
		                <view class="item-title" style="padding: 30rpx 20rpx;background-color: white;margin-bottom: 20rpx;" @click="open(item)">
							<view style="display: flex;align-items: center;justify-content: space-between;">
								...
								<view style="color: #515151;margin-top: 30rpx;">
									<view style="margin-bottom: 10rpx;">订单<text style="color: red;">{{item.amount}}元</text></view>
									<view>预计奖金:   <text style="color: #7e72ff;">{{item.expect_max_award}}元</text></view>
								</view>
							</view>
